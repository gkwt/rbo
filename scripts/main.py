...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset_name", action="store", type=str, help="Dataset to study."
    )
    parser.add_argument(
        "--num_workers",
        action="store",
    ...
    parser.add_argument(
        ...
        type=int,
        dest="num_runs",
        help="Number of runs in BO. Defaults 20.",
        default=20,
    )
    parser.add_argument(
        "--num_init",
        ...
        type=int,
        dest="num_init",
        help="Number of initial samples defaults 20.",
        default=20,
    )
    parser.add_argument(
        "--budget",
        ...
        type=int,
        dest="budget",
        help="Budget of surrogate supported iterations. Defaults 100.",
        default=100,
    )
    parser.add_argument(
        "--batch_size",
        ...
        type=int,
        dest="batch_size",
        help="Batch per iteration. Defaults 1.",
        default=1,
    )
    parser.add_argument(
        "--num_epochs",
        ...
        type=int,
        dest="num_epochs",
        help="Number of epochs per iteration. Defaults 5.",
        default=5,
    )
    parser.add_argument(
        "--maximize",
        action="store_true",
        dest="goal",
        help="Set goal to maximize. Otherwise will minimize.",
        default=False,
    )
    parser.add_argument(
        "--rank",
        action="store_true",
        help="Toggle use of ranking loss. Otherwise, MSE.",
        default=False,
    )
    parser.add_argument(
        "--acq_func",
        ...
        type=str,
        dest="acq_func",
        help="Acqusition function used. Defaults to greedy.",
        default="greedy",
    )
    parser.add_argument(
        "--model_type",
        ...
        type=str,
        dest="model_type",
        help="Change deep model used. Defaults to mlp.",
        default="mlp",
    )
    parser.add_argument(
        "--use_gpu",
        action="store_true",
        help="Toggle use of gpu. Most useful for BNN. Defaults false.",
        default=False,
    )
    parser.add_argument(
        "--scale",
        action="store_true",
        help="Toggle scaling of targets. Defaults false.",
        default=False,
    )
    parser.add_argument(
        "--test_ratio",
        ...
        type=float,
        dest="test_ratio",
        help="Size of testing set, set to 0 for no evaluation. \
                        Defaults 0.15.",
        default=0.15,
    )
    parser.add_argument(
        ...
        type=float,
        dest="learning_rate",
        help="Setting learning rate, defaults to 0.005.",
        default=0.005,
    )
    ...
    pickle.dump(
        bo_results,
        open(f"{work_dir}/results_{loss_type}_{dataset_name}_{goal}.pkl", "wb"),
    )
